...
/**
 * @file
 * Contains \Drupal\hwjma_mrct\Plugin\Block\MostRead.
 */
...
/**
 * Provides a 'MostReadCitedTopics' block.
 *
 * @Block(
 *   id = "most_read_cited",
 *   admin_label = @Translation("Highwire Most Read"),
 *   category = @Translation("Custom Most Read")
 * )
 */
class MostRead extends BlockBase implements ContainerFactoryPluginInterface  {
  /**
